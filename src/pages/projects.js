  ...
  return (
    <article className="w-full flex items-center justify-between rounded-3xl rounded-br-2xl border border-solid border-dark bg-light shadow-2xl p-6 relative dark:bg-dark dark:border-light lg:flex-col lg:p-8 xs:rounded-2xl xs:rounded-br-3xl xs:p-4">
      ...
      <div className="w-1/2 flex flex-col items-start justify-between pl-6 dark:text-light lg:w-full lg:pl-0 lg:pt-6">
        <span className="text-primary dark:text-teal-400 font-medium text-xl xs:text-base">
          {type}
        </span>
        <Link
          href={link}
  ...
  return (
    <article className="w-full flex flex-col items-center justify-center rounded-2xl border border-solid border-dark bg-light p-6 relative dark:bg-dark dark:border-light xs:p-4">
      ...
      <div className="w-full flex flex-col items-start justify-between mt-4 dark:text-light">
        <span className="text-primary dark:text-teal-400 font-medium text-xl lg:text-lg md:text-base">
          {type}
        </span>
        <Link
          href={link}
        ...
        <div className="mt-2 flex items-center justify-between flex-row-reverse w-full">
...
const projects = () => {
  return (
    <>
      <Head>
        <title>Projects | Tedi Julianto</title>
